  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-2 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <br />
        <p className="text-xl">
          I have expertise in HTML, CSS and CSS Frameworks like Bootstrap and Tailwind. I have a intermediate knowledge in JavaScript and good knowledge in React. I have worked with MongoDB for Database, Express.js and Node.js for backend.In my projects I uses this tools: Firebase, Figma, Netlify, Vercel, GitHub. I am passionate about staying up-to-date with
